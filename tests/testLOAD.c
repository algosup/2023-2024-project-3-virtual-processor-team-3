...
void testLb(void)
{
    uint memLb[] = 
    {
        0B00000000000000010001000010000011, // lb r1, 0(x2)
...
void testLh(void)
{
    uint memLh[] = 
    {
        0B00000000000000010010000010000011, // lh r1, 0(x2)
...
void testLw(void)
{
    uint memLw[] = 
    {
        0B00000000000000010011000010000011, // lw r1, 0(x2)
        //IIIIIIIIIIII11111333DDDDD0000000
...
void testLbu(void)
{
    uint memLbu[] = 
    {
        0B00000000000000010100000010000011, // lb r1, 0(x2)
        //IIIIIIIIIIII11111333DDDDD0000000
        0B00000000000000000000000010111111,
    };
...
void testLhu(void)
{
    uint memLhu[] = 
    {
        0B00000000000000010101000010000011, // lh r1, 0(x2)
        0B00000000000000001011111111111111,
    };
