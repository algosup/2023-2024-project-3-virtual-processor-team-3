...
- [Functional Specifications](#functional-specifications)
  ...
  - [3. Functional Requirements](#3-functional-requirements)
    - [3.1 Virtual Processor](#31-virtual-processor)
      ...
      - [➭ 3.1.2 Instructions Set](#-312-instructions-set)
...
| | `addi` | **Add Immediate** | Adds an immediate value to a register and stores the result in a register | `addi r2, r1, immediate` |
...
| | `syscall` | **System Call** | Calls a system function | `syscall` |
