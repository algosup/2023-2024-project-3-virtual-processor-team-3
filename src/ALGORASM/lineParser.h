                        ...
                        *directiveCheck = '\0';
                        ...
                        if (isDirectiveFound)
                        {
                            ...
                            if (strcmp(directiveName, "byte") == 0)
                            {
                                ...
                                while (*valuesStart && isspace((unsigned char)*valuesStart))
                                    valuesStart++;
                                ...
                                while (byteValueStr)
                                {
                                    ...
                                    while (isspace((unsigned char)*byteValueStr))
                                        byteValueStr++;
                            ...
                            if (strcmp(directiveName, "half") == 0)
                            {
                                ...
                                while (halfValueStr)
                                {
                                    ...
                                    while (isspace((unsigned char)*halfValueStr))
                                        halfValueStr++;
                            ...
                            if (strcmp(directiveName, "word") == 0)
                            {
                                ...
                                while (wordValueStr)
                                {
                                    ...
                                    // Trim leading spaces for each value
                                    while (isspace((unsigned char)*wordValueStr))
                                        wordValueStr++;
                            ...
                            if (strcmp(directiveName, "asciz") == 0)
                            {
                                ...
                                while (*stringValueStart && isspace((unsigned char)*stringValueStart))
                                    stringValueStart++;
                                ...
                                while (*lineEnd && isspace((unsigned char)*lineEnd))
                                    lineEnd++;
